...
export const siteConfig = {
  ...
  description:
    'VeriSafe Works keeps a complete, shared record of every job — documents, photos and audio conversations — for tradespeople, housing associations and the residents they work for.',
  contact: {
